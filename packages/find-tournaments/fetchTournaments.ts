...
export async function fetchTournaments() {
  ...
  return await fetch('https://tenup.fft.fr/system/ajax', {
    ...
    body: `recherche_type=ville&ville%5Bautocomplete%5D%5Bcountry%5D=fr&ville%5Bautocomplete%5D%5Btextfield%5D=&ville%5Bautocomplete%5D%5Bvalue_container%5D%5Bvalue_field%5D=Nantes%2C+44000&ville%5Bautocomplete%5D%5Bvalue_container%5D%5Blabel_field%5D=%3Cdiv+class%3D%22reference-autocomplete%22%3ENantes%2C+44%2C+Loire-Atlantique%2C+Pays+de+la+Loire%3C%2Fdiv%3E&ville%5Bautocomplete%5D%5Bvalue_container%5D%5Blat_field%5D=&ville%5Bautocomplete%5D%5Bvalue_container%5D%5Blng_field%5D=&ville%5Bdistance%5D%5Bvalue_field%5D=30&club%5Bautocomplete%5D%5Btextfield%5D=&club%5Bautocomplete%5D%5Bvalue_container%5D%5Bvalue_field%5D=&club%5Bautocomplete%5D%5Bvalue_container%5D%5Blabel_field%5D=&pratique=TENNIS&date%5Bstart%5D=27%2F02%2F23&date%5Bend%5D=27%2F05%2F23&tournois_interne=0&inscription_ligne=0&paiement_ligne=0&page=0&sort=_DIST_&form_build_id=${id}&form_id=recherche_tournois_form&_triggering_element_name=submit_main&_triggering_element_value=Rechercher`,
    method: 'POST',
  }).then((res) => res.json());
}
